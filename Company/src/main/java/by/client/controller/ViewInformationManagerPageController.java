...
public class ViewInformationManagerPageController  implements Initializable {
    ...
    loginField, otherExpensesProductionField, wagesCostField, overheadCostField, materialCostField, plannedRevenueField;

    @FXML
    private Text clickedLogout, mainPageNavigation, pricesPageNavigation, adminPageNavigation, allPricesPageNavigation, reportPageNavigation;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        loginField.setText(productLabel.getCreatedBy().getUsername());
    }
